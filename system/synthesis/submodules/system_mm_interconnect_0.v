...
module system_mm_interconnect_0 (
	...
	wire  [94:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> HEX0_s1_agent:cp_data
	...
	wire  [94:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> HEX1_s1_agent:cp_data
	...
	wire  [94:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> HEX2_s1_agent:cp_data
	...
	wire  [94:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> HEX3_s1_agent:cp_data
	...
	wire  [94:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> HEX5_s1_agent:cp_data
	...
	wire  [94:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> HEX4_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                              // HEX4_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [10:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> HEX4_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> SW_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                              // SW_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [10:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> SW_s1_agent:cp_channel
	...
	wire         hex0_s1_agent_rp_valid;                                                             // HEX0_s1_agent:rp_valid -> router_005:sink_valid
	wire  [94:0] hex0_s1_agent_rp_data;                                                              // HEX0_s1_agent:rp_data -> router_005:sink_data
	wire         hex0_s1_agent_rp_ready;                                                             // router_005:sink_ready -> HEX0_s1_agent:rp_ready
	wire         hex0_s1_agent_rp_startofpacket;                                                     // HEX0_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         hex0_s1_agent_rp_endofpacket;                                                       // HEX0_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         hex1_s1_agent_rp_valid;                                                             // HEX1_s1_agent:rp_valid -> router_006:sink_valid
	wire  [94:0] hex1_s1_agent_rp_data;                                                              // HEX1_s1_agent:rp_data -> router_006:sink_data
	wire         hex1_s1_agent_rp_ready;                                                             // router_006:sink_ready -> HEX1_s1_agent:rp_ready
	wire         hex1_s1_agent_rp_startofpacket;                                                     // HEX1_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         hex1_s1_agent_rp_endofpacket;                                                       // HEX1_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         hex2_s1_agent_rp_valid;                                                             // HEX2_s1_agent:rp_valid -> router_007:sink_valid
	wire  [94:0] hex2_s1_agent_rp_data;                                                              // HEX2_s1_agent:rp_data -> router_007:sink_data
	wire         hex2_s1_agent_rp_ready;                                                             // router_007:sink_ready -> HEX2_s1_agent:rp_ready
	wire         hex2_s1_agent_rp_startofpacket;                                                     // HEX2_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         hex2_s1_agent_rp_endofpacket;                                                       // HEX2_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         hex3_s1_agent_rp_valid;                                                             // HEX3_s1_agent:rp_valid -> router_008:sink_valid
	wire  [94:0] hex3_s1_agent_rp_data;                                                              // HEX3_s1_agent:rp_data -> router_008:sink_data
	wire         hex3_s1_agent_rp_ready;                                                             // router_008:sink_ready -> HEX3_s1_agent:rp_ready
	wire         hex3_s1_agent_rp_startofpacket;                                                     // HEX3_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         hex3_s1_agent_rp_endofpacket;                                                       // HEX3_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [94:0] hex5_s1_agent_rp_data;                                                              // HEX5_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [94:0] hex4_s1_agent_rp_data;                                                              // HEX4_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [94:0] sw_s1_agent_rp_data;                                                                // SW_s1_agent:rp_data -> router_012:sink_data
	...
	wire         hex0_s1_agent_rdata_fifo_src_valid;                                                 // HEX0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] hex0_s1_agent_rdata_fifo_src_data;                                                  // HEX0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         hex0_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_003:in_0_ready -> HEX0_s1_agent:rdata_fifo_src_ready
	...
	wire         hex1_s1_agent_rdata_fifo_src_valid;                                                 // HEX1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] hex1_s1_agent_rdata_fifo_src_data;                                                  // HEX1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         hex1_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_004:in_0_ready -> HEX1_s1_agent:rdata_fifo_src_ready
	...
	wire         hex2_s1_agent_rdata_fifo_src_valid;                                                 // HEX2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] hex2_s1_agent_rdata_fifo_src_data;                                                  // HEX2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         hex2_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_005:in_0_ready -> HEX2_s1_agent:rdata_fifo_src_ready
	...
	wire         hex3_s1_agent_rdata_fifo_src_valid;                                                 // HEX3_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] hex3_s1_agent_rdata_fifo_src_data;                                                  // HEX3_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         hex3_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_006:in_0_ready -> HEX3_s1_agent:rdata_fifo_src_ready
